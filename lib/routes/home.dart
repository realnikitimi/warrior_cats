...
class Home extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AvatarFrameBloc, AvatarFrameWithFile>(
      builder: (context, state) {
        if (state.frameListBuffer.isEmpty) {
          context.read<AvatarFrameBloc>().add(AvatarFrameSetFrames());
        }
        ...
        return Column(
          ...
          children: [
            TextButton(
              onPressed: () => context.read<AvatarFrameBloc>().add(
                AvatarFrameSelectFromGallery(),
              ),
              child: Text('Foo'),
            ),
            SingleChildScrollView(
              ...
              child: Row(
                children: state.frameListBuffer
                    .map((b) => Image.memory(b.uintArray))
                    .toList(),
              ),
            ),
            BlocSelector<
            ...
            >(
              ...
              builder: (context, state) {
                return TextButton(
                  ...
                  child: Text('${state.selectedImageToJson?.path}'),
                );
              },
            ),
          ],
